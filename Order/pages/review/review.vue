    ...
    <view class="content">
      ...
      <view class="review-form">
        <view class="review-rate-form mb-20">
          <rate-form-item
            v-model="form.score_service"
            label="服务"
            tips="能感受到良好的服务态度吗？"
          ></rate-form-item>
          <rate-form-item
            v-model="form.score_order"
            label="点单"
            tips="点单有恰当的介绍，快速准确地下单吗？"
          ></rate-form-item>
          <rate-form-item
            v-model="form.score_speed"
            label="速度"
            tips="出品的速度您认为可接受吗？"
          ></rate-form-item>
          <rate-form-item
            v-model="form.score_product"
            label="产品"
            tips="您享用的茶饮或面包，如您所期待吗？"
          ></rate-form-item>
          <rate-form-item
            v-model="form.score_enviroment"
            label="环境"
            tips="门店环境和清洁卫生，您满意吗？"
          ></rate-form-item>
        </view>
...
export default {
  ...
  methods: {
    submit() {
      if (
        !this.form.score_service ||
        !this.form.score_order ||
        !this.form.score_speed ||
        !this.form.score_product ||
        !this.form.score_enviroment
      ) {
        uni.showToast({
          title: "请先选择评论内容",
          icon: "none",
