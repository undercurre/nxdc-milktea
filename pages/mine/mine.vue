<template>
  <view class="container">
    <view class="position-relative">
      <image src="/static/images/bg.jpg" class="bg"></image>
      ...
      <view class="d-flex flex-column bg-white user-box">
        <view class="d-flex align-items-center">
          ...
          >
            ...
            <view class="font-size-sm text-color-assist">
              当前成长值{{ isLogin ? member.currentValue : 0 }}/{{
                isLogin ? member.currentValue + member.needValue : 0
              }}
            </view>
            <view class="w-100">
              <progress
        ...
        <view class="w-100 d-flex align-items-center just-content-center">
          <view class="user-grid" @tap="coupons">
            ...
            <view class="font-size-sm text-color-assist">消费券</view>
          </view>
